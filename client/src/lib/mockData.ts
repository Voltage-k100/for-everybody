...
export const initialPosts: Post[] = [
  {
    id: "p1",
    authorId: "u3",
    content: "Acabei de ler um estudo fascinante sobre como redes sociais podem ser projetadas para reduzir polarização em vez de alimentá-la. A chave? Dar às pessoas espaço para contexto, não apenas manchetes.\n\nÉ exatamente isso que queremos construir aqui. Um lugar onde a conversa importa mais que o clique.",
  ...
  },
  {
    id: "p4",
    authorId: "u4",
    content: "Lancei meu primeiro single hoje. Trabalhei nisto durante 8 meses e mal posso acreditar que está no mundo. Para todos que apoiam a arte independente: obrigado. Isto é para todos, para todo o mundo.",
  ...
  },
  {
    id: "p6",
    authorId: "u2",
    content: "Dica de dev: se você ainda não experimentou TypeScript com inferência de tipos estrita, está perdendo metade da diversão.\n\nO compilador encontra bugs que você nem sabia que tinha. É como ter um par-programador que nunca dorme.",
  ...
  },
  {
    id: "p8",
    authorId: "u8",
    content: "Estudei 14 horas hoje e o meu cérebro parece gelatina. Mas valeu — cada página lida é um paciente futuro que vai receber melhor cuidado.\n\nPara todos os estudantes lá fora: o esforço de hoje é a diferença de amanhã.",
  ...
  },
  {
    id: "p9",
    authorId: "u3",
    content: "A internet precisa de mais praças e menos arenas. Lugares onde as pessoas conversam, não onde gritam.\n\nIsto não é utopia — é uma escolha de design.",
    timestamp: now - 1 * day,
    likes: 890,
    reposts: 312,
    comments: 134,
  ...
  },
  {
    id: "p10",
    authorId: "u5",
    content: "Pequeno lembrete: a melhor ferramenta de IA é a que te ajuda a pensar melhor, não a que pensa por ti.\n\nUsa tecnologia para ampliar tua voz, não para substituí-la.",
